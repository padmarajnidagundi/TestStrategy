...
Artificial Intelligence (AI) – Systems that perceive, learn, and act autonomously.

Definition of IA and AI Effect – Understanding impacts of intelligence augmentation.

Narrow, General and Super AI – Classifications of AI capability levels.

AI-Based Systems vs. Conventional Systems – Differences relevant to testing approaches.

AI Technologies – Tools and methods used in AI systems.

AI Development Frameworks – Frameworks used to build AI models.

Hardware for AI-Based Systems – Specialized computing resources (e.g., GPUs).

AI as a Service (AIaaS) – Cloud-hosted AI solutions.

Pre-Trained Models – Models trained on external datasets prior to deployment.

Standards, Regulations and AI – Governance and compliance related to AI.

*🧠 **AI System Quality Characteristics***

Flexibility and Adaptability – Ability to evolve with data or environment changes.

Autonomy – Level of self-directed operation by AI.

Evolution – System learning and changing over time.

Bias – Systematic error leading to unfair or skewed outcomes.

Ethics – Moral implications of AI behavior and decisions.

Side Effects and Reward Hacking – Unintended or manipulated outcomes.

Transparency, Interpretability, Explainability – Clarity of AI decision mechanics.

Safety and AI – Ensuring AI does not create harmful effects.

*📊 **Machine Learning (ML) Fundamentals***

Forms of ML (Supervised, Unsupervised, Reinforcement) – Major learning categories.

ML Workflow – Stages from data collection to evaluation.

Selecting a Form of ML – Choosing ML approach for a task.

Factors in ML Algorithm Selection – Criteria for choosing algorithms.

Overfitting & Underfitting – Model performance problems.

ML Data – Data used for ML training and testing.

Data Preparation – Cleaning and structuring data.

Training, Validation, Test Datasets – Splits used in ML building.

Dataset Quality Issues – Problems that affect model performance.

Data Labelling (Supervised Learning) – Assigning ground-truth labels.

ML Functional Performance Metrics – Measures used to assess models.

Confusion Matrix – Classification performance tool.

Classification, Regression & Clustering Metrics – Performance types.

*🔍 **AI Testing Techniques & Challenges***

Specification of AI-Based Systems – Test challenges due to loosely defined requirements.

Test Levels of AI-Based Systems – Component, integration, system, etc.

Test Data for Testing AI Systems – Test case and dataset design.

Testing for Automation Bias – Identifying bias due to automation trust.

Testing for Concept Drift – Handling changing data distributions over time.

Selecting a Test Approach for ML Systems – Tailoring tests to model behavior.

Testing AI-Specific Quality Characteristics – E.g., interpretability, bias.

Challenges Testing Self-Learning Systems – Non-static behavior over time.

Testing Complex & Non-Deterministic Systems – Outcomes inconsistent by nature.

Test Oracles for AI-Based Systems – How to determine correct outputs.

*🧪 **Structured Test Methods***

Adversarial Attacks & Data Poisoning – Deliberate model manipulation testing.

Pairwise Testing – Testing combinations of input pairs.

A/B Testing – Comparing two variants.

Back-to-Back Testing – Comparing outputs of two systems.

Metamorphic Testing (MT) – Using relations between inputs/outputs.

Experience-Based Testing – Testing based on tester intuition and expertise.

*🧠 **Using AI in Testing***

AI Technologies for Testing – Tools that support testing processes.

Using AI to Analyze Defect Reports – Automated insights from bug logs.

AI for Test Case Generation – Automatically creating test cases.

AI for Regression Suite Optimization – Improving regression test sets.

AI for Defect Prediction – Forecasting where bugs may occur.

AI for Testing User Interfaces – Using AI to assess UI behavior.